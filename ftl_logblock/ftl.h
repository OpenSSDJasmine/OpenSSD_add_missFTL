...
// if necessary, allocate DRAM memory here and add allocated bytes to DRAM_BYTES_OTHER macro
// also, add allocated bytes to dram_requirement variable in sanity_check()
//#define LOG_BLK_MAP         (BAD_BLK_BMP_ADDR + BAD_BLK_BMP_BYTES)
//#define LOG_BLK_MAP_BYTES   (32 * 1024)
